...
module sushi::smart_chef_test {
    ...
    fun test_pool_all_in_one(
        ...
        add_reward<TestSUSHI, TestBUSD, U0>(admin, (total_reward * 10 / 100));
        let (_, expected_total_reward_token, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        ...
        add_reward<TestSUSHI, TestBUSD, U0>(admin, (total_reward * 90 / 100));
        total_reward_token = total_reward_token + (total_reward * 90 / 100);

        let (expected_total_stake_token, expected_total_reward_token, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        ...
        let alice_sushi_before_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        deposit<TestSUSHI, TestBUSD, U0>(alice, 1);
        let alice_sushi_after_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        (expected_total_stake_token, expected_total_reward_token, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        total_stake_token = total_stake_token + 1;

        assert!(alice_sushi_before_balance - alice_sushi_after_balance == 1, 96);
        ...
        let bob_sushi_before_balance = coin::balance<TestSUSHI>(signer::address_of(bob));
        deposit<TestSUSHI, TestBUSD, U0>(bob, 2);
        let bob_sushi_after_balance = coin::balance<TestSUSHI>(signer::address_of(bob));
        (expected_total_stake_token, expected_total_reward_token, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        total_stake_token = total_stake_token + 2;

        assert!(bob_sushi_before_balance - bob_sushi_after_balance == 2, 93);
        ...
        alice_sushi_before_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        let alice_pending_reward = get_pending_reward<TestSUSHI, TestBUSD, U0>(signer::address_of(alice));
        withdraw<TestSUSHI, TestBUSD, U0>(alice, 1);
        let alice_busd_after_balance = coin::balance<TestBUSD>(signer::address_of(alice));
        alice_sushi_after_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        (expected_total_stake_token, expected_total_reward_token, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        total_stake_token = total_stake_token - 1;
        ...
        assert!(alice_sushi_after_balance - alice_sushi_before_balance == 1, 89);
        ...
        let alice_sushi_before_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        deposit<TestSUSHI, TestBUSD, U0>(alice, 2);
        alice_pending_reward = get_pending_reward<TestSUSHI, TestBUSD, U0>(signer::address_of(alice));
        let alice_sushi_after_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        (expected_total_stake_token, expected_total_reward_token, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        total_stake_token = total_stake_token + 2;

        assert!(alice_pending_reward == 0, 85);
        assert!(alice_sushi_before_balance - alice_sushi_after_balance == 2, 84);
        ...
        alice_sushi_before_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        alice_pending_reward = get_pending_reward<TestSUSHI, TestBUSD, U0>(signer::address_of(alice));
        withdraw<TestSUSHI, TestBUSD, U0>(alice, 2);
        ...
        assert!(alice_sushi_after_balance - alice_sushi_before_balance == 2, 81);
        ...
        bob_sushi_before_balance = coin::balance<TestSUSHI>(signer::address_of(bob));
        let bob_pending_reward = get_pending_reward<TestSUSHI, TestBUSD, U0>(signer::address_of(bob));
        withdraw<TestSUSHI, TestBUSD, U0>(bob, 2);
        let bob_busd_after_balance = coin::balance<TestBUSD>(signer::address_of(bob));
        bob_sushi_after_balance = coin::balance<TestSUSHI>(signer::address_of(bob));
        (expected_total_stake_token, expected_total_reward_token, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        total_stake_token = total_stake_token - 2;
        ...
        assert!(bob_sushi_after_balance - bob_sushi_before_balance == 2, 77);
        ...
        bob_sushi_before_balance = coin::balance<TestSUSHI>(signer::address_of(bob));
        deposit<TestSUSHI, TestBUSD, U0>(bob, 1);
        bob_pending_reward = get_pending_reward<TestSUSHI, TestBUSD, U0>(signer::address_of(bob));
        bob_sushi_after_balance = coin::balance<TestSUSHI>(signer::address_of(bob));
        (expected_total_stake_token, expected_total_reward_token, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        total_stake_token = total_stake_token + 1;

        assert!(bob_pending_reward == 0, 73);
        assert!(bob_sushi_before_balance - bob_sushi_after_balance == 1, 72);
        ...
        assert!(alice_sushi_before_balance - alice_sushi_after_balance == 2, 68);
        ...
        alice_busd_before_balance = coin::balance<TestBUSD>(signer::address_of(alice));
        alice_pending_reward = get_pending_reward<TestSUSHI, TestBUSD, U0>(signer::address_of(alice));
        withdraw<TestSUSHI, TestBUSD, U0>(alice, 0);
        alice_sushi_after_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        alice_busd_after_balance = coin::balance<TestBUSD>(signer::address_of(alice));
        (expected_total_stake_token, expected_total_reward_token, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        ...
        assert!(alice_sushi_before_balance - alice_sushi_after_balance == 0, 64);
        ...
        assert!(get_user_stake_amount<TestSUSHI, TestBUSD, U0>(signer::address_of(alice)) == 1, 59);
        assert!(alice_sushi_after_balance - alice_sushi_before_balance == 1, 58);
        ...
        assert!(get_user_stake_amount<TestSUSHI, TestBUSD, U0>(signer::address_of(bob)) == 3, 53);
        assert!(bob_sushi_before_balance - bob_sushi_after_balance == 2, 52);
        ...
        assert!(get_user_stake_amount<TestSUSHI, TestBUSD, U0>(signer::address_of(alice)) == 0, 48);
        assert!(alice_sushi_after_balance - alice_sushi_before_balance == 1, 47);
        ...
        assert!(get_user_stake_amount<TestSUSHI, TestBUSD, U0>(signer::address_of(bob)) == 5, 43);
        assert!(bob_sushi_before_balance - bob_sushi_after_balance == 2, 42);
        ...
        bob_sushi_before_balance = coin::balance<TestSUSHI>(signer::address_of(bob));
        bob_pending_reward = get_pending_reward<TestSUSHI, TestBUSD, U0>(signer::address_of(bob));
        withdraw<TestSUSHI, TestBUSD, U0>(bob, 5);
        bob_busd_after_balance = coin::balance<TestBUSD>(signer::address_of(bob));
        bob_sushi_after_balance = coin::balance<TestSUSHI>(signer::address_of(bob));
        (expected_total_stake_token, expected_total_reward_token, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        ...
        assert!(bob_sushi_after_balance - bob_sushi_before_balance == 5, 37);
    ...
    fun test_pool_rapid_deposit_withdraw(
        ...
        test_coins::register_and_mint<TestSUSHI>(&coin_owner, alice, 20000000000 * pow(10, 8));
        test_coins::register_and_mint<TestBUSD>(&coin_owner, bob, 20000000000 * pow(10, 8));
        test_coins::register_and_mint<TestSUSHI>(&coin_owner, bob, 20000000000 * pow(10, 8));
        ...
        deposit<TestSUSHI, TestBUSD, U0>(bob, 100000000000000000);
        deposit<TestSUSHI, TestBUSD, U0>(alice, 20);
        timestamp::update_global_time_for_test_secs(start_time + 1);

        deposit<TestSUSHI, TestBUSD, U0>(alice, 0);
        ...
        let bob_busd_before_balance = coin::balance<TestBUSD>(signer::address_of(bob));
        deposit<TestSUSHI, TestBUSD, U0>(bob, 0);
        let bob_busd_after_balance = coin::balance<TestBUSD>(signer::address_of(bob));
    ...
    fun test_create_pool(
        ...
        create_pool<TestSUSHI, TestBUSD, U0>(admin, reward_per_second, start_time, end_time, pool_limit_per_user, time_for_user_limit);
        let (expected_total_stake_token, expected_total_reward_token, expected_reward_per_second, expected_start_timestamp, expected_end_timestamp, expected_time_for_user_limit, expected_pool_limit_per_user) = get_pool_info<TestSUSHI, TestBUSD, U0>();
    ...
    fun test_create_pool_not_admin(
        ...
        let start_time = timestamp::now_seconds() + 10;
        let end_time = start_time + 100;
        create_pool<TestSUSHI, TestBUSD, U0>(dev, 1, start_time, end_time, 0, 0);
    }
    ...
    fun test_create_pool_reward_token_not_exist(
        ...
        let start_time = timestamp::now_seconds() + 10;
        let end_time = start_time + 100;
        create_pool<TestSUSHI, U0, U0>(admin, 1, start_time, end_time, 0, 0);
    }
    ...
    fun test_create_pool_already_exist(
        ...
        let start_time = timestamp::now_seconds() + 10;
        let end_time = start_time + 100;
        create_pool<TestSUSHI, TestBUSD, U0>(admin, 1, start_time, end_time, 0, 0);
        create_pool<TestSUSHI, TestBUSD, U0>(admin, 1, start_time, end_time, 0, 0);
    }
    ...
    fun test_create_pool_stake_and_reward_same_token(
        ...
        let start_time = timestamp::now_seconds() + 10;
        let end_time = start_time + 100;
        create_pool<TestSUSHI, TestSUSHI, U0>(admin, 1, start_time, end_time, 0, 0);
    }
    ...
    fun test_create_pool_with_limits(
        ...
        let start_time = timestamp::now_seconds() + 10;
        let end_time = start_time + 100;
        create_pool<TestSUSHI, TestBUSD, U0>(admin, 1, start_time, end_time, pool_limit_per_user, time_for_user_limit);
        let (expected_total_stake_token, expected_total_reward_token, expected_reward_per_second, expected_start_timestamp, expected_end_timestamp, expected_time_for_user_limit, expected_pool_limit_per_user) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        assert!(expected_total_stake_token == 0, 99);
        assert!(expected_total_reward_token == 0, 98);
        assert!(expected_reward_per_second == reward_per_second, 97);
    ...
    fun test_create_pool_zero_pool_limits(
        ...
        let start_time = timestamp::now_seconds() + 10;
        let end_time = start_time + 100;
        create_pool<TestSUSHI, TestBUSD, U0>(admin, 1, start_time, end_time, 0, 1000);
    }
    ...
    fun test_create_pool_wrong_uid(
        ...
        let start_time = timestamp::now_seconds() + 10;
        let end_time = start_time + 100;
        create_pool<TestSUSHI, TestBUSD, U0>(admin, 1, start_time, end_time, 100, 1000);
        create_pool<TestSUSHI, TestBUSD, U2>(admin, 1, start_time, end_time, 100, 1000);
    }
    ...
    fun test_create_pool_unreasonable_token_decimal(
        ...
        let start_time = timestamp::now_seconds() + 10;
        let end_time = start_time + 100;
        create_pool<TestSUSHI, Test30DEC, U0>(admin, 1, start_time, end_time, 10, 1000);
    }
    ...
    fun test_add_reward(
        ...
        let end_time = start_time + 100;
        let reward = 100;
        create_pool<TestSUSHI, TestBUSD, U0>(admin, 1, start_time, end_time, 10, 1000);
        let admin_busd_before_balance = coin::balance<TestBUSD>(signer::address_of(admin));
        add_reward<TestSUSHI, TestBUSD, U0>(admin, reward);
    ...
    fun test_add_reward_after_reward_change(
        ...
        create_pool<TestSUSHI, TestBUSD, U0>(admin, 1, start_time, end_time, 10, 1000);
        let admin_busd_before_balance = coin::balance<TestBUSD>(signer::address_of(admin));
        add_reward<TestSUSHI, TestBUSD, U0>(admin, first_reward);
        let (_, expected_total_reward_token, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        assert!(expected_total_reward_token == first_reward, 99);
        let second_reward = 52;
        update_reward_per_second<TestSUSHI, TestBUSD, U0>(admin, 10);
        add_reward<TestSUSHI, TestBUSD, U0>(admin, second_reward);
        let admin_busd_after_balance = coin::balance<TestBUSD>(signer::address_of(admin));
        let (_, expected_total_reward_token, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
    ...
    fun test_add_reward_not_admin(
        ...
        let end_time = start_time + 100;
        create_pool<TestSUSHI, TestBUSD, U0>(admin, 1, start_time, end_time, 10, 1000);
        add_reward<TestSUSHI, TestBUSD, U0>(dev, 100);
    }
    ...
    fun test_add_reward_not_enough_balance(
        ...
        let start_time = timestamp::now_seconds() + 10;
        let end_time = start_time + 100;
        create_pool<TestSUSHI, TestBUSD, U0>(admin, 10 * pow(10, 8), start_time, end_time, 10, 1000);
        add_reward<TestSUSHI, TestBUSD, U0>(admin, 100 * pow(10, 8));
    }
    ...
    fun test_add_reward_pool_not_exist(
        ...
        let end_time = start_time + 100;
        create_pool<TestSUSHI, TestBUSD, U0>(admin, 1, start_time, end_time, 10, 1000);
        add_reward<TestSUSHI, TestUSDC, U0>(admin, 100);
    }
    ...
    fun test_deposit(
        ...
        let end_time = start_time + 100;
        create_pool<TestSUSHI, TestBUSD, U0>(admin, 1, start_time, end_time, 10, 1000);
        add_reward<TestSUSHI, TestBUSD, U0>(admin, 100);
        ...
        let alice_sushi_after_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        let (expected_total_stake_token, _, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        let user_stake_amount = get_user_stake_amount<TestSUSHI, TestBUSD, U0>(signer::address_of(alice));

        assert!(user_stake_amount == stake_amount, 99);
        assert!(alice_sushi_before_balance - alice_sushi_after_balance == stake_amount, 98);
    ...
    fun test_deposit_after_time_limit(
        ...
        assert!(alice_sushi_before_balance - alice_sushi_after_balance == first_stake_amount + second_stake_amount, 98);
    ...
    fun test_deposit_after_update_pool_limit(
        ...
        update_pool_limit_per_user<TestSUSHI, TestBUSD, U0>(admin, true, new_pool_limit_per_user);
    ...
    fun test_deposit_pool_not_exist(
        ...
        deposit<TestSUSHI, TestBUSD, U2>(alice, stake_amount);
    }
    ...
    fun test_deposit_no_reward(
        ...
        deposit<TestSUSHI, TestBUSD, U0>(alice, stake_amount);
        let alice_sushi_after_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        assert!((alice_sushi_before_balance - alice_sushi_after_balance) == stake_amount, 99);
    }
    ...
    fun test_deposit_after_emergency_reward_withdraw(
        ...
        timestamp::update_global_time_for_test_secs(start_time);
        emergency_reward_withdraw<TestSUSHI, TestBUSD, U0>(admin);
        let stake_amount = 10;
        let alice_sushi_before_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        deposit<TestSUSHI, TestBUSD, U0>(alice, stake_amount);
        let alice_sushi_after_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
    ...
    fun test_withdraw(
        ...
        let alice_sushi_before_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        withdraw<TestSUSHI, TestBUSD, U0>(alice, withdraw_amount);
        let alice_sushi_after_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        let (expected_total_stake_token, _, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        let user_stake_amount = get_user_stake_amount<TestSUSHI, TestBUSD, U0>(signer::address_of(alice));

        assert!(user_stake_amount == 0, 99);
        assert!(alice_sushi_after_balance - alice_sushi_before_balance == stake_amount, 99);
    ...
    fun test_withdraw_partial_after_time_limit(
        ...
        assert!(alice_sushi_after_balance - alice_sushi_before_balance == withdraw_amount, 98);
    ...
    fun test_withdraw_pool_not_exist(
        ...
        timestamp::update_global_time_for_test_secs(start_time + time_for_user_limit);
        let withdraw_amount = stake_amount;
        withdraw<TestSUSHI, TestBUSD, U2>(alice, withdraw_amount);
    }
    ...
    fun test_withdraw_no_stake(
        ...
        timestamp::update_global_time_for_test_secs(start_time + time_for_user_limit);
        let withdraw_amount = stake_amount;
        withdraw<TestSUSHI, TestBUSD, U0>(bob, withdraw_amount);
    }
    ...
    fun test_emergency_withdraw(
        ...
        deposit<TestSUSHI, TestBUSD, U0>(alice, stake_amount);
        let alice_sushi_before_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        emergency_withdraw<TestSUSHI, TestBUSD, U0>(alice);
        let alice_sushi_after_balance = coin::balance<TestSUSHI>(signer::address_of(alice));
        let (expected_total_stake_token, _, _, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
        let user_stake_amount = get_user_stake_amount<TestSUSHI, TestBUSD, U0>(signer::address_of(alice));
    ...
    fun test_emergency_withdraw_pool_not_exist(
        ...
        let stake_amount = 10;
        deposit<TestSUSHI, TestBUSD, U0>(alice, stake_amount);
        emergency_withdraw<TestSUSHI, TestBUSD, U2>(alice);
    }
    ...
    fun test_emergency_withdraw_no_stake(
        ...
        let stake_amount = 10;
        deposit<TestSUSHI, TestBUSD, U0>(alice, stake_amount);
        emergency_withdraw<TestSUSHI, TestBUSD, U0>(bob);
    }
    ...
    fun test_emergency_reward_withdraw_not_admin(
        ...
        let stake_amount = 10;
        deposit<TestSUSHI, TestBUSD, U0>(alice, stake_amount);
        emergency_reward_withdraw<TestSUSHI, TestBUSD, U0>(alice);
    }
    ...
    fun test_emergency_reward_withdraw_pool_not_exist(
        ...
        let stake_amount = 10;
        deposit<TestSUSHI, TestBUSD, U0>(alice, stake_amount);
        emergency_reward_withdraw<TestSUSHI, TestBUSD, U2>(admin);
    }
    ...
    fun test_stop_reward(
        ...
        timestamp::update_global_time_for_test_secs(start_time + time_for_user_limit);
        stop_reward<TestSUSHI, TestBUSD, U0>(admin);
        let (_, _, _, _, expected_end_timestamp, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
    ...
    fun test_stop_reward_not_admin(
        ...
        deposit<TestSUSHI, TestBUSD, U0>(alice, stake_amount);
        timestamp::update_global_time_for_test_secs(start_time + time_for_user_limit);
        stop_reward<TestSUSHI, TestBUSD, U0>(alice);
    }
    ...
    fun test_stop_reward_pool_not_exist(
        ...
        deposit<TestSUSHI, TestBUSD, U0>(alice, stake_amount);
        timestamp::update_global_time_for_test_secs(start_time + time_for_user_limit);
        stop_reward<TestSUSHI, TestBUSD, U2>(admin);
    }
    ...
    fun test_update_pool_limit_per_user(
        ...
        let (_, _, _, _, _, expected_time_for_user_limit, expected_pool_limit_per_user) = get_pool_info<TestSUSHI, TestBUSD, U0>();
    ...
    fun test_update_pool_limit_false_time_limit(
        ...
        create_pool<TestSUSHI, TestBUSD, U0>(admin, reward_per_second, start_time, end_time, pool_limit_per_user, time_for_user_limit);
        let new_pool_limit_per_user = pool_limit_per_user + 10;
        update_pool_limit_per_user<TestSUSHI, TestBUSD, U0>(admin, false, new_pool_limit_per_user);
    ...
    fun test_update_pool_limit_not_admin(
        ...
        create_pool<TestSUSHI, TestBUSD, U0>(admin, reward_per_second, start_time, end_time, pool_limit_per_user, time_for_user_limit);
        let new_pool_limit_per_user = pool_limit_per_user + 10;
        update_pool_limit_per_user<TestSUSHI, TestBUSD, U0>(alice, false, new_pool_limit_per_user);
    }
    ...
    fun test_update_pool_limit_pool_not_exist(
        ...
        create_pool<TestSUSHI, TestBUSD, U0>(admin, reward_per_second, start_time, end_time, pool_limit_per_user, time_for_user_limit);
        let new_pool_limit_per_user = pool_limit_per_user + 10;
        update_pool_limit_per_user<TestSUSHI, TestBUSD, U2>(admin, false, new_pool_limit_per_user);
    }
    ...
    fun test_update_reward_per_second(
        ...
        update_reward_per_second<TestSUSHI, TestBUSD, U0>(admin, new_reward_per_second);

        let (_, _, expected_reward_per_second, _, _, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
    ...
    fun test_update_reward_per_second_not_admin(
        ...
        create_pool<TestSUSHI, TestBUSD, U0>(admin, reward_per_second, start_time, end_time, pool_limit_per_user, time_for_user_limit);
        let new_reward_per_second = 2;
        update_reward_per_second<TestSUSHI, TestBUSD, U0>(alice, new_reward_per_second);
    }
    ...
    fun test_update_reward_per_second_pool_not_exist(
        ...
        create_pool<TestSUSHI, TestBUSD, U0>(admin, reward_per_second, start_time, end_time, pool_limit_per_user, time_for_user_limit);
        let new_reward_per_second = 2;
        update_reward_per_second<TestSUSHI, TestBUSD, U2>(admin, new_reward_per_second);
    }
    ...
    fun test_update_start_and_end_timestamp(
        ...
        update_start_and_end_timestamp<TestSUSHI, TestBUSD, U0>(admin, new_start_time, new_end_time);

        let (_, _, _, expected_start_time, expected_end_time, _, _) = get_pool_info<TestSUSHI, TestBUSD, U0>();
    ...
    fun test_update_start_and_end_timestamp_not_admin(
        ...
        let new_start_time = start_time + 10;
        let new_end_time = end_time + 10;
        update_start_and_end_timestamp<TestSUSHI, TestBUSD, U0>(alice, new_start_time, new_end_time);
    }
    ...
    fun test_update_start_and_end_timestamp_pool_not_exist(
        ...
        let new_start_time = start_time + 10;
        let new_end_time = end_time + 10;
        update_start_and_end_timestamp<TestSUSHI, TestBUSD, U2>(admin, new_start_time, new_end_time);
    }

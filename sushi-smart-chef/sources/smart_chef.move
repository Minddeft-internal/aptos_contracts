module sushi::smart_chef {
    ...
    use std::string;
    use sushi::u256;
    use sushi_phantom_types::uints::get_number;

    const DEFAULT_ADMIN: address = @sushi_smart_chef_default_admin;
    const RESOURCE_ACCOUNT: address = @sushi;
    const DEV: address = @sushi_smart_chef_dev;
